...
if("TRUE" STREQUAL "TRUE")
  set(pitt_object_table_segmentation_SOURCE_PREFIX /home/durgesh/catkin_ws/src/pitt_object_table_segmentation)
  set(pitt_object_table_segmentation_DEVEL_PREFIX /home/durgesh/catkin_ws/src/pitt_object_table_segmentation/cmake-build-debug/devel)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pitt_object_table_segmentation' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'pitt_object_table_segmentation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/durgesh/catkin_ws/src/pitt_object_table_segmentation/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/durgesh/catkin_ws/src/pitt_object_table_segmentation/cmake-build-debug/devel/lib;/home/durgesh/rosjava/devel/lib;/home/durgesh/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
...
set(depends "pcl_conversions;roscpp;sensor_msgs;pcl_msgs;pitt_msgs;message_generation;std_msgs")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${pitt_object_table_segmentation_dep}_FOUND)
      find_package(${pitt_object_table_segmentation_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pitt_object_table_segmentation_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
